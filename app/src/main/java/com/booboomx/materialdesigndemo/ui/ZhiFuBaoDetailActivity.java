...
import com.booboomx.materialdesigndemo.adapter.ToolbarAdapter;

public class ZhiFuBaoDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhi_fu_bao_detail);
